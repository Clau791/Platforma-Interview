...
from app.api.routes import audio, auth, code, emotion, health, messages, models, profile, report, sessions
...
api_router.include_router(audio.router, prefix="/sessions", tags=["audio"])
